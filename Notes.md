...
*** 试题下载成功后，请使用MD5码校验工具生成文件MD5值是否与本界面的【试题MD5码】一致，若一致，则表示文件正确。**

试题md码：93E646F959C91A536C693CE366646F5D
...
![这里写图片描述](docs/20170112160649586)
...
它从一个初始可行解出发，选择一系列的特定搜索方向（移动）作为试探，选择实现让特定的目标函数值变化最多的移动。为了避免陷入局部最优解。（和贪心算法比较）
...
https://www.cnblogs.com/HMBBas/p/11212799.html

* Biogeography-based Optimization BBO
* 08年，Dan Simon
* 基于遗传算法和粒子群算法
* 适用于解决高维度、多目标的最优问题
* 假设有100组自变量（x1, x2, ...），对应100个因变量。
* 通过迁入迁出、和变异的操作来增加每组数据的多样性



#### 组合优化（离散优化）

https://suzhouxing.github.io/techive/
...
在每一步都做出最优的选择，比如旅行商问题，每次都选择离自己当前位置为接近的城市。

对于有最优子结构的问题及其有效，最优子结构的意思是局部最优解能决定全局最优解。简单地说，问题能够分解成子问题来解决，子问题的最优解能递推到最终问题的最优解。

找零钱也是一种贪心算法

<img src="docs/image-20200915001727246.png" alt="image-20200915001727246" style="zoom:50%;" />
